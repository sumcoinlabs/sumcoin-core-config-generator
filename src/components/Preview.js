...
function toConf (settings, defaults) {
  ...
  const configPath = joinPath([basePath(platform), 'sumcoin.conf'], platform);
  conf.unshift(
    '# Made possible by open source at - https://github.com/sumcoinlabs/sumcoin-core-config-generator/sumcoin-core-config-generator/\n',
